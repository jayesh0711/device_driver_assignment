...
static int file_rinit driver2_init(void);
static void     __exelease(struct inode *inode, struct file *file)
{
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("CDAC");
MODULE_DESCRIPTION("Concept of UserSpace Application To Hardware(Internel Memory)");
